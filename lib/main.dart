...
Icon isOnimg = Icon(Totoro.studio_ghibli);
        ...
        Column(
          ...
          children: [
            ...
            Flexible(
                flex: 1,
                child: Container(
                  child: Text("History of Studio Ghilbi",
            ...
            onPressed: () {
              setState(() {
                if (isOn == Colors.red[200]) {
                  isOn = Colors.grey;
                  isOnimg = Icon(Totoro.studio_ghibli);
                  print("Jadi abu");
                } else {
                  isOn = Colors.red[200];
                  isOnimg = Icon(Totoro.totoro);
                  print("Jadi merah");
                }
              });
            },
